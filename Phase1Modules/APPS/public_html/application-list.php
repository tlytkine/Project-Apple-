...
$query = "SELECT * FROM application, academicinfo, personalinfo
WHERE application.id=academicinfo.applicationid AND application.id=personalinfo.applicationid AND status='Complete'";
