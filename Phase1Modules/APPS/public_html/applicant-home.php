...
<a href="personal-info.php">Personal Information</a> <br />
<a href="editable-application.php">Application</a> <br />
...
<?php
	...
	if ($rows != 1) {
		...
		$query = "INSERT INTO application(email, status, finaldecision)
			VALUE('{$_SESSION["email"]}', 'Incomplete', 0)";
		$result = mysqli_query($connection, $query);
		if (!$result) {
