...
if (isset($_GET['review'])) {
    ...
    $updatereviewer  = " UPDATE application SET reviewerusername='" . $_SESSION['email'] . "' WHERE id = '" . $_SESSION['currentid'] . "'";
    ...
    $query2   = "SELECT * FROM application, academicinfo,personalinfo  WHERE application.id = personalinfo.applicationid AND application.id= academicinfo.applicationid AND application.id='" . $_SESSION['currentid'] . "'";
