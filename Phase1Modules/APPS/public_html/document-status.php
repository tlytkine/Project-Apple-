...
<?php
	...
	$query = "SELECT documentstatus.applicationid, personalinfosubmitted, applicationsubmitted, transcriptrecieved, letterofrecrecieved, firstname, lastname, status
		FROM documentstatus, personalinfo, application
		WHERE documentstatus.applicationid = personalinfo.applicationid AND  documentstatus.applicationid = application.id";
