...
<?php 
	...
	if ($applicationclearedsucessfully){
		...
		if(!($applicationclearedsucessfully) && (!$alreadysubmitted)){
			echo "
			<p>Fill out the following form to submit an application for graduation. Your application will not be cleared unless you have satisfied all of the degree requirements. You can view the requirements for your degree and your status in the main menu.</p>
